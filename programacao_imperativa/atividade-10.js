...
function imprimirInverso(nomes) {
  console.log(nomes.reverse())
}

let nomes = ['João', 'Carlos', 'Maria', 'Roberto', 'Francisca']
...
console.log(capitalizar(catalogo[(0, 1, 2, 3, 4)]))
...
for (let index = 0; index < asiaScores.length; index++) {
  console.log(
    asiaScores[index] == euroScores[index]
      ? 'O valor ' + asiaScores[index] + ' é igual a ' + euroScores[index]
      : 'O valor ' + asiaScores[index] + ' é difernte de ' + euroScores[index]
  )
}
